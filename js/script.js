...
(function ($) {
  $(document).ready(function () {
    ...
    // Slick overlay arrow prev slide
    $(document).on('click', '.cic-slick-left', function (e) {
      e.preventDefault()
      $($(this).attr('data-slider')).slick('slickPrev')
    })
    // Slick overlay arrow next slide
    $(document).on('click', '.cic-slick-right', function (e) {
      e.preventDefault()
      $($(this).attr('data-slider')).slick('slickNext')
    })

    // How many img tags don't have width & height? (for development)
